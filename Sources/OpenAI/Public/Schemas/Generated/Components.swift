...
//
//  Generated by `make generate` from openapi.yaml with Swift OpenAPI Generator; see the Makefile and
//  CONTRIBUTING.md, "Implementing using Code Generation". Do not edit by hand, regenerate instead.
//  Everything up to `#endif` is kept by Scripts/postprocess_components.py; everything below it is replaced.
//
...
public enum Components {
    ...
    public enum Schemas {
        ...
        public struct CodeInterpreterToolCall: Codable, Hashable, Sendable {
            ...
            ///   - outputs: The outputs generated by the code interpreter, such as logs or images.
            public init(
        ...
        public struct CreateResponse: Codable, Hashable, Sendable {
            ...
            public struct Value3Payload: Codable, Hashable, Sendable {
                ...
                ///   - streamOptions:
                ///   - conversation:
                ///   - contextManagement: Context management configuration for this request.
        ...
        @frozen public enum CreateTranscriptionRequest: Sendable, Hashable {
            ...
            public struct ChunkingStrategyPayload: Sendable, Hashable {
                ...
                /// - Parameters:
                ///   - body:
                public init(body: Components.Schemas.CreateTranscriptionRequest.ChunkingStrategyPayload.BodyPayload) {
                    self.body = body
                }
            }
        ...
        @frozen public enum ItemResource: Codable, Hashable, Sendable {
            ...
            public init(from decoder: any Swift.Decoder) throws {
                ...
                case "ComputerToolCall", "#/components/schemas/ComputerToolCall", "computer_call":
                    self = .computerToolCall(try .init(from: decoder))
                case "ComputerToolCallOutputResource", "#/components/schemas/ComputerToolCallOutputResource", "computer_call_output":
                    self = .computerToolCallOutputResource(try .init(from: decoder))
                case "WebSearchToolCall", "#/components/schemas/WebSearchToolCall", "web_search_call":
                    self = .webSearchToolCall(try .init(from: decoder))
                case "FunctionToolCallResource", "#/components/schemas/FunctionToolCallResource", "function_call":
                    self = .functionToolCallResource(try .init(from: decoder))
                case "FunctionToolCallOutputResource", "#/components/schemas/FunctionToolCallOutputResource", "function_call_output":
                ...
                case "MCPToolCall", "#/components/schemas/MCPToolCall", "mcp_call":
                    self = .mcpToolCall(try .init(from: decoder))
                case "CustomToolCallResource", "#/components/schemas/CustomToolCallResource", "custom_tool_call":
                    self = .customToolCallResource(try .init(from: decoder))
                case "CustomToolCallOutputResource", "#/components/schemas/CustomToolCallOutputResource", "custom_tool_call_output":
        ...
        public struct ModelResponseProperties: Codable, Hashable, Sendable {
            ...
            ///   - serviceTier:
            ///   - promptCacheRetention: The retention policy for the prompt cache. Set to `24h` to enable extended prompt caching, which keeps cached prefixes active for longer, up to a maximum of 24 hours. [Learn more](/docs/guides/prompt-caching#prompt-cache-retention).
            public init(
        ...
        public struct Response: Codable, Hashable, Sendable {
            ...
            public struct Value3Payload: Codable, Hashable, Sendable {
                ...
                ///   - completedAt: Unix timestamp (in seconds) of when this Response was completed.
                ///   - error:
        ...
        public struct WebSearchTool: Codable, Hashable, Sendable {
            ...
            public struct FiltersPayload: Codable, Hashable, Sendable {
                ...
                ///
                /// - Parameters:
                ///   - allowedDomains: Allowed domains for the search. If not provided, all domains are allowed.
        ...
        public struct ClickParam: Codable, Hashable, Sendable {
            ...
            ///   - keys: The keys being held while clicking.
            public init(
        ...
        public struct DoubleClickAction: Codable, Hashable, Sendable {
            ...
            ///   - keys: The keys being held while double-clicking.
            public init(
        ...
        public struct DragParam: Codable, Hashable, Sendable {
            ...
            ///   - keys: The keys being held while dragging the mouse.
            public init(
        ...
        public struct MoveParam: Codable, Hashable, Sendable {
            ...
            ///   - keys: The keys being held while moving the mouse.
            public init(
        ...
        public struct ScrollParam: Codable, Hashable, Sendable {
            ...
            ///   - keys: The keys being held while scrolling.
            public init(
        ...
        public struct ToolSearchCall: Codable, Hashable, Sendable {
            ...
            ///   - callId: The unique ID of the tool search call generated by the model.
        ...
        public struct FunctionShellAction: Codable, Hashable, Sendable {
            ...
            /// - Parameters:
            ///   - commands:
            ///   - timeoutMs: Optional timeout in milliseconds for the commands.
            ///   - maxOutputLength: Optional maximum number of characters to return from each command.
            public init(
        ...
        public struct FunctionShellCallOutput: Codable, Hashable, Sendable {
            ...
            ///   - maxOutputLength: The maximum length of the shell command output. This is generated by the model and should be passed back with the raw output.
            ///   - createdBy: The identifier of the actor that created the item.
            public init(
        ...
        public struct ApplyPatchToolCallOutput: Codable, Hashable, Sendable {
            ...
            ///   - output: Optional textual output returned by the apply patch tool.
        ...
        public struct InputFileContentParam: Codable, Hashable, Sendable {
            ...
            ///   - fileId: The ID of the file to be sent to the model.
            ///   - filename: The name of the file to be sent to the model.
            ///   - fileData: The base64-encoded data of the file to be sent to the model.
            ///   - fileUrl: The URL of the file to be sent to the model.
            ///   - detail: The detail level of the file to be sent to the model. Use `low` for the default rendering behavior, or `high` to render the file at higher quality. Defaults to `low`.
            public init(
        ...
        public struct ToolSearchCallItemParam: Codable, Hashable, Sendable {
            ...
            ///
            /// - Parameters:
            ///   - id: The unique ID of this tool search call.
            ///   - callId: The unique ID of the tool search call generated by the model.
        ...
        public struct ToolSearchOutputItemParam: Codable, Hashable, Sendable {
            ...
            ///
            /// - Parameters:
            ///   - id: The unique ID of this tool search output.
            ///   - callId: The unique ID of the tool search call generated by the model.
        ...
        public struct CompactionSummaryItemParam: Codable, Hashable, Sendable {
            ...
            ///
            /// - Parameters:
            ///   - id: The ID of the compaction item.
            ///   - _type: The type of the item. Always `compaction`.
        ...
        public struct FunctionShellCallItemParam: Codable, Hashable, Sendable {
            ...
            ///   - action: The shell commands and limits that describe how to run the tool call.
            ///   - status:
            ///   - environment: The environment to execute the shell commands in.
            public init(
                id: Swift.String? = nil,
                callId: Swift.String,
        ...
        public struct FunctionShellCallOutputItemParam: Codable, Hashable, Sendable {
            ...
            ///
            /// - Parameters:
            ///   - id: The unique ID of the shell tool call output. Populated when this item is returned via API.
            ///   - callId: The unique ID of the shell tool call generated by the model.
        ...
        public struct ApplyPatchToolCallOutputItemParam: Codable, Hashable, Sendable {
            ...
            ///   - callId: The unique ID of the apply patch tool call generated by the model.
            ///   - status: The status of the apply patch tool call output. One of `completed` or `failed`.
            ///   - output: Optional human-readable log text from the apply patch tool (e.g., patch results or errors).
            public init(
        ...
        public struct ContextManagementParam: Codable, Hashable, Sendable {
            ...
            ///   - compactThreshold: Token threshold at which compaction should be triggered for this entry.
            public init(
                _type: Swift.String,
