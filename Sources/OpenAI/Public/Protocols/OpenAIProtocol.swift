...
public protocol OpenAIProtocol {
    ...
    **/
    func images_generate(query: ImageGenerateParams, completion: @escaping (Result<ImagesResponse, Error>) -> Void)
    ...
    /**
     ...
     - Parameters:
       ...
       - completion: A closure which receives the result when the API request finishes. The closure's parameter, `Result<ImagesResponse, Error>`, will contain either the `ImagesResult` object with the generated images, or an error if the request failed.
    **/
    func images_edit(query: ImageEditParams, completion: @escaping (Result<ImagesResponse, Error>) -> Void)
    ...
    /**
     ...
     - Parameters:
       ...
       - completion: A closure which receives the result when the API request finishes. The closure's parameter, `Result<ImagesResponse, Error>`, will contain either the `ImagesResult` object with the generated images, or an error if the request failed.
    **/
    func images_create_variation(query: ImageCreateVariationParams, completion: @escaping (Result<ImagesResponse, Error>) -> Void)
    ...
    **/
    func embeddings_create(query: EmbeddingCreateParams, completion: @escaping (Result<EmbeddingResponse, Error>) -> Void)
    ...
    **/
    func chat_completions(query: ChatCompletionCreateParams, completion: @escaping (Result<ChatCompletion, Error>) -> Void)
    ...
    **/
    func chat_with_streaming_response_completions(query: ChatCompletionCreateParams, onResult: @escaping (Result<ChatCompletionChunk, Error>) -> Void, completion: ((Error?) -> Void)?)
    ...
    **/
    func models_retreive(query: ModelCreateParams, completion: @escaping (Result<Model, Error>) -> Void)

    func models_delete(query: ModelCreateParams, completion: @escaping (Result<ModelDeleted, Error>) -> Void)
    ...
    **/
    func models_list(completion: @escaping (Result<ModelsResponse, Error>) -> Void)
    ...
    **/
    func moderations_create(query: ModerationCreateParams, completion: @escaping (Result<ModerationCreateResponse, Error>) -> Void)
     ...
     */
    func audio_speech_create(query: SpeechCreateParams, completion: @escaping (Result<Speech, Error>) -> Void)
     ...
     **/
    func audio_transcriptions_create(query: TranscriptionCreateParams, completion: @escaping (Result<Transcription, Error>) -> Void)
     ...
     **/
    func audio_translations_create(query: TranslationCreateParams, completion: @escaping (Result<Translation, Error>) -> Void)
}
