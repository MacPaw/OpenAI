...
public enum ImagesSize: String, Codable {
    case _256 = "256x256"
    case _512 = "512x512"
...
public struct ImagesQuery: Codable {
    ...
    public init(prompt: String, model: ImageModel?=nil, responseFormat: Self.ResponseFormat?=nil, n: Int?, size: ImagesSize?, style: String?=nil, user:String?=nil, quality:String?=nil) {
        self.style = style
        self.prompt = prompt
        self.n = n
        self.size = size
