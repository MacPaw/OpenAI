...
public struct ImagesQuery: Codable {
    ...
    public init(prompt: String, model: ImageModel?=nil, responseFormat: Self.ResponseFormat?=nil, n: Int?, size: Size?, style: String?=nil, user:String?=nil, quality:String?=nil) {
        self.style = style
        self.prompt = prompt
        self.n = n
        self.size = size
