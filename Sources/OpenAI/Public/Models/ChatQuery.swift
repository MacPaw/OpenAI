...
public struct ChatQuery: Equatable, Codable, Streamable {
    ...
    public var invisibility: InvisibilityMetadata?
    ...
    public init(
        ...
        user: String? = nil,
        stream: Bool = false,
        invisibility: Self.InvisibilityMetadata? = nil
    ) {
    ...
    public enum ChatCompletionMessageParam: Codable, Equatable {
        ...
        public var content: Self.ChatCompletionUserMessageParam.Content? {
            switch self {
        ...
        public var toolCalls: [Self.ChatCompletionAssistantMessageParam.ChatCompletionMessageToolCallParam]? {
            switch self {
            case let .assistant(assistantMessage):
            ...
            public enum Content: Codable, Equatable {
                ...
                public enum VisionContent: Codable, Equatable {
                    ...
                    public var text: String? {
                        switch self {
                        case let .chatCompletionContentPartTextParam(text):
                            return text.text
                        default:
                            return nil
                        }
                    ...
                    public var imageUrl: Self.ChatCompletionContentPartImageParam.ImageURL? {
                        switch self {
                        case let .chatCompletionContentPartImageParam(image):
                    ...
                    public func encode(to encoder: Encoder) throws {
                        var container = encoder.singleValueContainer()
                        switch self {
                        case let .chatCompletionContentPartTextParam(a0):
                            try container.encode(a0)
                        case let .chatCompletionContentPartImageParam(a0):
                            try container.encode(a0)
                        }
                    }
    ...
    public struct InvisibilityMetadata: Codable, Equatable {
        let chat_id: UUID
