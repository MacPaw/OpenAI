...
public extension Model {
    ...
    /// `gpt-audio-1.5`: Latest audio model for Chat Completions with improved instruction following, tool calling, and multilingual accuracy.
    ...
    static func allModels(satisfying filter: Filter) -> Set<Model> {
        let chatCompletionsEndpoint: Set<Model> = [
            ...
            // cost-optimized
            .gpt4_1_mini, .gpt4_1_nano, .gpt4_o_mini, .gpt_4o_mini_audio_preview, .gpt_audio_1_5,
            // tool-specific
