...
- CI: the *Swift Build* workflow now builds and tests on Linux with Swift 5.10, 6.0 and 6.3 containers, tests on macOS and the iOS Simulator, and builds for tvOS, watchOS and visionOS with Xcode.
- CONTRIBUTING.md: API stability policy, including how generated `Components.Schemas` types are treated.
- This changelog.
